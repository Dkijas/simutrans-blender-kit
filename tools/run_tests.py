...
def suite_package():
    """The publication package: what goes in, what must not, and reproducibility."""
    return _run([sys.executable, os.path.join("tests", "test_package.py")], ROOT,
                "PACKAGE_TESTS_OK", ("PACKAGE_TESTS_FAILED", "Traceback"), 120,
                "package")


def suite_components():
    """The component catalogue: licences, relative paths, missing parts."""
    return _run([sys.executable, os.path.join("tests", "test_components.py")], ROOT,
                "COMPONENT_TESTS_OK", ("COMPONENT_TESTS_FAILED", "Traceback"), 120,
                "components")
